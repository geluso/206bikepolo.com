        ...
        <div id='main'>
          ...
          <div>
            <ul>
              ...
              <li>
                <a href='https://www.instagram.com/206bikepolo/'>
                  @206bikepolo
                </a>{' '}
                on Instagram
              </li>
              <li>
                Talk to everyone on{' '}
                <a href='https://join.slack.com/t/seattlebikepolo/shared_invite/zt-2im5od2df-FlTl~Oc9YVC8feu95iVM8g'>
                  Slack
                </a>
              </li>
              <li>
                Edit this website on <a href=''>GitHub</a>. FTP and GitHub
                access avaialble upon request.
              </li>
            </ul>
          </div>
