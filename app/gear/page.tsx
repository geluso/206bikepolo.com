  ...
  return (
    <div className="page">
      ...
      <div className="mb-2 mt-2">
        ...
        polo people (less than 1%) that still ride this way. Traditionally, in
        the early 2000s, people did indeed ride with a fixed gear
        <ul className="ps-6 list-disc">
          <li>
            the wheel and pedals always stay rotating... aka feet always
            move{" "}
          </li>
        </ul>
      </div>
      ...
      <div className="mb-2 mt-2">
        But due to fast stopping and ability to hop, people moved to single
        speed freewheels!
        <ul className="ps-6 list-disc">
      ...
      <p className="mb-2 mt-2">
        ...
        <a href="https://www.facebook.com/marketplace/">FB marketplace</a> for
        ~$100
      </p>
      ...
      <ol className="ps-6 list-decimal">
        ...
        <ul className="ps-3 my-2 list-disc list-inside">
          <li>
            Strong frame (<b>steel or aluminum</b>)
          </li>
          ...
          <li>
            Effective top tube length being roughly 1 size smaller than
            recommended{" "}
          </li>
        ...
        <ul className="ps-3 my-2 list-disc list-inside">
          ...
          <li>
            <b>Cover for front wheel </b>(and optional back wheel)
          </li>
          <ul className="ps-6 list-disc list-inside">
            <li>
        ...
        <ul className="ps-3 my-2 list-disc list-inside">
          <li>
            People have tried building mallet heads in the past but very
            complicated.{" "}
          </li>
          <li>Most people try 3d printing the head</li>
          <ul className="ps-6 list-disc list-inside">
            <li>
              But essentially all 3d print filament (PLA, PETG, etc) is too
              brittle and will shatter after a couple hits
            </li>
          </ul>
        ...
        <ul className="ps-3 my-2 list-disc list-inside">
          ...
          <ul className="ps-6 mb-2 list-disc list-inside">
            ...
            <ul className="ps-6 list-disc list-inside">
              ...
              <li>
                Disc break gets very hot from breaking and if someone falls on
                it, it can burn skin
              </li>
              <li>
                Many people make their own and are very unique{" "}
                <a href="https://www.instagram.com/no_words_just_guards/">
                  instagram
                </a>
              </li>
              <li>
                Purchasable on <a href="hecklersalley.com">hecklersalley</a>
              </li>
            </ul>
            <li>Bar End Caps</li>
            <ul className="ps-6 list-disc list-inside">
              <li>
                At each end of the handlebar, you need a cap to protect someone
                from landing on it
              </li>
            </ul>
          </ul>
