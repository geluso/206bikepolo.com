        ...
        <div className="tournament-bracket">
            ...
            <div className="round round-1">
                <div className="match">
                    ...
                    <div className="team">Team 16 <input type="number" value={0} /></div>
                    <div className="team">Team 17 <input type="number" value={0} /></div>
                </div>
                <div className="match">
            ...
            <div className="round round-2">
                ...
                <div className="match">
                    ...
                    <div className="team">Team 2 <input type="number" /></div>
                </div>
                <div className="match">
